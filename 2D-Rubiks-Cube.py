...
def resetTheCube():
	...
	pieces = [Piece(1,0,0,0,0,0,0,"UB","edge"),Piece(2,0,0,0,0,0,0,"UL","edge"),Piece(3,0,0,0,0,0,0,"UF","edge"),Piece(4,0,0,0,0,0,0,"UR","edge"),Piece(0,1,0,0,0,0,1,"FU","edge"),Piece(0,2,0,0,0,0,1,"FL","edge"),Piece(0,3,0,0,0,0,1,"FD","edge"),Piece(0,4,0,0,0,0,1,"FR","edge"),Piece(0,0,1,0,0,0,2,"RU","edge"),Piece(0,0,2,0,0,0,2,"RF","edge"),Piece(0,0,3,0,0,0,2,"RD","edge"),Piece(0,0,4,0,0,0,2,"RB","edge"),Piece(0,0,0,1,0,0,3,"BU","edge"),Piece(0,0,0,2,0,0,3,"BR","edge"),Piece(0,0,0,3,0,0,3,"BD","edge"),Piece(0,0,0,4,0,0,3,"BL","edge"),Piece(0,0,0,0,1,0,4,"LU","edge"),Piece(0,0,0,0,2,0,4,"LB","edge"),Piece(0,0,0,0,3,0,4,"LD","edge"),Piece(0,0,0,0,4,0,4,"LF","edge"),Piece(0,0,0,0,0,1,5,"DF","edge"),Piece(0,0,0,0,0,2,5,"DL","edge"),Piece(0,0,0,0,0,3,5,"DB","edge"),Piece(0,0,0,0,0,4,5,"DR","edge"),Piece(1,0,0,0,0,0,0,"UBR","corner"),Piece(2,0,0,0,0,0,0,"UBL","corner"),Piece(3,0,0,0,0,0,0,"UFL","corner"),Piece(4,0,0,0,0,0,0,"UFR","corner"),Piece(0,1,0,0,0,0,1,"FUR","corner"),Piece(0,2,0,0,0,0,1,"FUL","corner"),Piece(0,3,0,0,0,0,1,"FDL","corner"),Piece(0,4,0,0,0,0,1,"FDR","corner"),Piece(0,0,1,0,0,0,2,"RUB","corner"),Piece(0,0,2,0,0,0,2,"RUF","corner"),Piece(0,0,3,0,0,0,2,"RDF","corner"),Piece(0,0,4,0,0,0,2,"RDB","corner"),Piece(0,0,0,1,0,0,3,"BUL","corner"),Piece(0,0,0,2,0,0,3,"BUR","corner"),Piece(0,0,0,3,0,0,3,"BDR","corner"),Piece(0,0,0,4,0,0,3,"BDL","corner"),Piece(0,0,0,0,1,0,4,"LUF","corner"),Piece(0,0,0,0,2,0,4,"LUB","corner"),Piece(0,0,0,0,3,0,4,"LDB","corner"),Piece(0,0,0,0,4,0,4,"LDF","corner"),Piece(0,0,0,0,0,1,5,"DFR","corner"),Piece(0,0,0,0,0,2,5,"DFL","corner"),Piece(0,0,0,0,0,3,5,"DBL","corner"),Piece(0,0,0,0,0,4,5,"DBR","corner"),Piece(0,0,0,0,0,0,0,"U","cap"),Piece(0,0,0,0,0,0,1,"F","cap"),Piece(0,0,0,0,0,0,2,"R","cap"),Piece(0,0,0,0,0,0,3,"B","cap"),Piece(0,0,0,0,0,0,4,"L","cap"),Piece(0,0,0,0,0,0,5,"D","cap"),
	]
	# Define a seperate array to address 24 edge pieces.
	edges = [pieces[0],pieces[1],pieces[2],pieces[3],pieces[4],pieces[5],pieces[6],pieces[7],pieces[8],pieces[9],pieces[10],pieces[11],pieces[12],pieces[13],pieces[14],pieces[15],pieces[16],pieces[17],pieces[18],pieces[19],pieces[20],pieces[21],pieces[22],pieces[23]]
	# Define a seperate array to address 24 corner pieces.  
	corners = [pieces[24],pieces[25],pieces[26],pieces[27],pieces[28],pieces[29],pieces[30],pieces[31],pieces[32],pieces[33],pieces[34],pieces[35],pieces[36],pieces[37],pieces[38],pieces[39],pieces[40],pieces[41],pieces[42],pieces[43],pieces[44],pieces[45],pieces[46],pieces[47]]
	# Define a seperate array to address 6 cap pieces.  
	caps = [pieces[48],pieces[49],pieces[50],pieces[51],pieces[52],pieces[53]]
